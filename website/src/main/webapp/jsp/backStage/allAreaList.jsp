...
<%--数据表格--%>
    ...
    <script type="text/javascript">
        function toAddArea() {
            location.href="${pageContext.request.contextPath}/m/adminToAddArea";
        }
        function toUpdate(areaId) {
            location.href="${pageContext.request.contextPath}/m/adminToUpdateArea?areaId="+areaId;
        }
        function todel(areaId) {
            location.href="${pageContext.request.contextPath}/m/adminTodelArea?areaId="+areaId;
        }
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-outline-primary" onclick="toAddArea()">添加地点</button>
                            <%--查询--%>
                        ...
                        <tbody>
                            <c:forEach items="${allArea}" var="allAreaS">
                                <tr style="height: 52px;">
                                    <td style="width: 3%;text-align: center">${allAreaS.areaId}</td>
                                    <td style="width: 6%;text-align: center">${allAreaS.areaName}</td>
                                    </td>
                                    <td style="width: 91%;text-align: right">
                                        <button type="button"  class="btn btn-outline-info"  onclick="toUpdate(${allAreaS.areaId})">修改</button>
                                        <button type="button" disabled class="btn btn-outline-danger"  onclick="todel(${allAreaS.areaId})">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
