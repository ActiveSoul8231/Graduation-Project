...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../bootstrap3/css/common.css" />
    <link rel="stylesheet" type="text/css" href="../../bootstrap3/css/slide.css" />
    <link rel="stylesheet" type="text/css" href="../../bootstrap3/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="../../bootstrap3/css/flat-ui.min.css" />
    <link rel="stylesheet" type="text/css" href="../../bootstrap3/css/jquery.nouislider.css">
</head>
<style type="text/css">
    .del{
        margin-top: 5%;
...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        <div id="logoDiv">
            <p id="logoP"><img id="logo" alt="左右结构项目" src="https://activesoul8231.github.io/favicon11.ico"><span>院校失物招领管理</span></p>
        </div>
        <div id="personInfor">
            <p id="userName">${admin.uName}</p>
            <p><span>${admin.uEmail}</span><br> <a href="${pageContext.request.contextPath}/m/getMassagesList" target="_blank">客户端首页</a></p>
            <p>
                <a href="${pageContext.request.contextPath}/user/adminLogout">退出登录</a>
            </p>
        </div>
        <div class="meun-title">账号管理</div>
        <div class="meun-item meun-item-active" href="#sour1" aria-controls="sour1" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_source.png">资源管理</div>
        <div class="meun-item" href="#char" aria-controls="char" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_chara_grey.png">权限管理</div>
        <div class="meun-item" href="#user" aria-controls="user" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_user_grey.png">用户管理</div>
        <div class="meun-item" href="#chan" aria-controls="chan" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_change_grey.png">修改密码</div>
        <div class="meun-title">地区管理</div>
        <div class="meun-item" <%--href="#scho"--%> aria-controls="scho" role="tab" data-toggle="tab" onclick="toGetArea()"><img src="../../bootstrap3/images/icon_house_grey.png">地区管理</div>
        <div class="meun-item" href="#regu" aria-controls="regu" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_rule_grey.png">规则管理</div>
        <div class="meun-item" href="#stud" aria-controls="stud" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_card_grey.png">人员信息</div>
        <div class="meun-item" href="#sitt" aria-controls="sitt" role="tab" data-toggle="tab"><img src="../../bootstrap3/images/icon_char_grey.png">座位管理</div>
    </div>
    <!-- 右侧具体内容栏目 -->
    <div id="rightContent">
        ...
        <div class="tab-content">
            <!-- 消息资源管理模块 -->
            <div role="tabpanel" class="tab-pane active" id="sour1">
                    ...
                    <div class="tablebody">
                        <c:forEach items="${allMsg}" var="allMsgS">
                            <div class="row">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    ${allMsgS.mArticleTypeId}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" style="overflow: hidden;line-height: 70px;height: 70px;">
                                    ${allMsgS.mTitle}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    ${allMsgS.mUId}
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" >
                                    <img src="${allMsgS.mImage} "style="width:88px;height: 58px;border-radius: 15px;">
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    ${allMsgS.mArticleTime}
                                </div>
                                <c:if test="${allMsgS.mType eq '1'}">
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                        <p class="text-primary del-2">寻物启事</p>
                                    </div>
                                </c:if>
                                <c:if test="${allMsgS.mType eq '0'}">
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                        <p class="text-danger del-2">失物招领</p>
                                    </div>
                                </c:if>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <c:if test="${allMsgS.mPostStatus eq '1'}">
                                        <button type="button" class="btn btn-warning del-1" data-toggle="tooltip" data-placement="left" title="如果您的这个物品已寻回，请点我" onclick="toPost(${allMsgS.mId})">取消发布</button>
                                    </c:if>
                                    <c:if test="${allMsgS.mPostStatus eq '0'}">
                                        <button type="button" class="btn btn-success del-1" data-toggle="tooltip" data-placement="left" title="需要公开展示消息？点我公开" onclick="toPost(${allMsgS.mId})">重新发布</button>
                                    </c:if>
                                </div>
                                ...
                                <%--<div id="topAD" class="col-lg-4 col-md-4 col-sm-4 col-xs-4" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSystem" aria-expanded="true" aria-controls="collapseOne">--%>
                                        <%--&lt;%&ndash;<span id="topA" class="glyphicon  glyphicon-triangle-bottom  "></span> &ndash;%&gt;<span>${allMsgS.mTitle}</span>--%>
                                <%--</div>--%>
                                <%--<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">--%>
                                    <%--<img src="${allMsgS.mImage}" style="width:100px;height:60px;border-radius: 5px;" >--%>
                                <%--</div>--%>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                    ...
                                    <c:if test="${allMsgS.mDelStatus eq '0'}">
                                        <button type="button" class="btn btn-danger del" data-toggle="tooltip" data-placement="top" title="删除后的信息将在个人中心消失，如需恢复请联系管理员" onclick="todel(${allMsgS.mId})">删除消息</button>
                                    </c:if>
                                    <c:if test="${allMsgS.mDelStatus eq '1'}">
                                        <button type="button" class="btn btn-primary del" data-toggle="tooltip" data-placement="top" title="删除后的信息将在个人中心消失，如需恢复请联系管理员" onclick="todel(${allMsgS.mId})">恢复消息</button>
                                    </c:if>
                                </div>
                            </div>
                        </c:forEach>
            ...
            <div role="tabpanel" class="tab-pane" id="scho">
                ...
                <div class="check-div form-inline">
                    <div class="col-xs-3">
                        <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addArea">添加地区 </button>
                    </div>
                ...
                <div class="data-div" id="allAreaTest">
                    <div class="row tableHeader">
                        <div class="col-xs-1 ">
                            地区ID
                        </div>
                    ...
                    <%--<div class="tablebody">--%>
                        <%--<c:forEach items="${allArea}" var="allAreas">--%>
                            <%--<div class="row">--%>
                                <%--<div class="col-xs-1 ">--%>
                                        <%--${allAreas.areaId}--%>
                                <%--</div>--%>
                ...
                <div class="modal fade" id="addArea" role="dialog" aria-labelledby="gridSystemModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="text" name="areaName" class="form-control input-sm duiqi" id="sName" placeholder="">
                                            </div>
                                        </div>
                                       --%>
                                    </form>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-xs btn-white" data-dismiss="modal">取 消</button>
                                <button type="button" class="btn btn-xs btn-green" onclick="toAddArea()">保 存</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                    </div>
...
-->
<script src="../../bootstrap3/js/jquery.nouislider.js"></script>

<!-- this page specific inline scripts -->
<script>
    function toGetArea() {

        $("#scho").addClass("active");
        debugger;
        $.ajax({
            type:"GET",
            url:"${pageContext.request.contextPath}/m/toGetArea",
            dataType:"json",
            success:function(obj1){
                $.each(obj1.AllArea111,function(index,item){
                    var tr;
                    tr='<div class="row">'+'<div class="col-xs-1">'+item.areaId+'</div>'+'<div class="col-xs-2">'+item.areaName+'</div>'+'<div class="col-xs-7">'+'</div>'+'<div class="col-xs-2">'+'<button class="btn btn-success btn-xs" data-toggle="modal" data-target="#reviseSchool">修改</button>'+'<button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteSchool">删除</button>'+'</div>'+'</div>'
                    $("#allAreaTest").append('<div class="tablebody">'+tr+'</div>')
                    //window.location.href="#scho";
                    //$("#scho").addClass("active");
                })
            }
        })
