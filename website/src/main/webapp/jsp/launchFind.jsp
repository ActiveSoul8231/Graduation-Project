...
<div class="container-fluid" style="padding:0px;">
    ...
    <div class="container">
        ...
        <div class="row massage">
            <div class="col-md">
                <form id="toLaunchF" action="${pageContext.request.contextPath}/m/toLaunchF" method="post" enctype="multipart/form-data">
                    <%--丢失地点--%>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control Wdate" id="lostTime" name="mArticleTime" <%--value="${lostTime}"--%> type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})">
                        </div>
