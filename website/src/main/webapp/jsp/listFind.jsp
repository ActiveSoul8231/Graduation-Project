            ...
            <div class="row massage" id="banners">
                <div class="col-md-12">
                    <div class="feed_tegao long">
                        <h4>
                            <a href="${pageContext.request.contextPath}/m/toDetails?mId=${typeOne.mId}" target="_blank">${typeOne.mAreaId}:${typeOne.mTitle}</a>
                        </h4>
                        <p class="picture"><a href="${pageContext.request.contextPath}/m/toDetails?mId=${typeOne.mId}" target="_blank"><img src="${typeOne.mImage}" alt="${typeOne.mAreaId}:${typeOne.mTitle}"></a></p>
